...
export default class Rabbit extends React.PureComponent {
    renderTemplate = () => {
        const { color } = this.props;

        return (
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="40.000000pt" height="40.000000pt" viewBox="0 0 1266.000000 1280.000000"
                preserveAspectRatio="xMidYMid meet">
                <g transform="translate(0.000000,1280.000000) scale(0.080000,-0.0800000)"
    ...
    render() {
        return (
            <div style={{ display: "inline-block" }}>
                <div classID="NPCRabbitId">{this.renderTemplate()}</div>
            </div>
        );
    }
}
